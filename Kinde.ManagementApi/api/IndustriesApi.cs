...
namespace Kinde.ManagementApi.Api
{
    ...
    public partial class IndustriesApi : IDisposable, IIndustriesApi
    {
        ...
        /// <returns></returns>
        public IndustriesApi(Kinde.ManagementApi.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public IndustriesApi(HttpClient client, Kinde.ManagementApi.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public IndustriesApi(Kinde.ManagementApi.Client.ISynchronousClient client, Kinde.ManagementApi.Client.IAsynchronousClient asyncClient, Kinde.ManagementApi.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> localVarResponse = GetIndustriesWithHttpInfo(industryKey, name);
        ...
        /// <param name="name">Industry name. (optional)</param>
        /// <returns>ApiResponse of SuccessResponse</returns>
        public Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> GetIndustriesWithHttpInfo(string? industryKey = default(string?), string? name = default(string?))
        {
        ...
        {
            Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> localVarResponse = await GetIndustriesWithHttpInfoAsync(industryKey, name, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SuccessResponse)</returns>
        public async System.Threading.Tasks.Task<Kinde.ManagementApi.Client.ApiResponse<SuccessResponse>> GetIndustriesWithHttpInfoAsync(string? industryKey = default(string?), string? name = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
