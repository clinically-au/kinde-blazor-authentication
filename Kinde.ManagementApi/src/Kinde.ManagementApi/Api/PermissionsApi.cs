...
namespace Kinde.ManagementApi.Api
{
    ...
    public partial class PermissionsApi : IDisposable, IPermissionsApi
    {
        ...
        /// <returns></returns>
        public PermissionsApi(Kinde.ManagementApi.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public PermissionsApi(HttpClient client, Kinde.ManagementApi.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public PermissionsApi(Kinde.ManagementApi.Client.ISynchronousClient client, Kinde.ManagementApi.Client.IAsynchronousClient asyncClient, Kinde.ManagementApi.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> localVarResponse = CreatePermissionWithHttpInfo(createPermissionRequest);
        ...
        /// <param name="createPermissionRequest">Permission details. (optional)</param>
        /// <returns>ApiResponse of SuccessResponse</returns>
        public Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> CreatePermissionWithHttpInfo(CreatePermissionRequest? createPermissionRequest = default(CreatePermissionRequest?))
        {
        ...
        {
            Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> localVarResponse = await CreatePermissionWithHttpInfoAsync(createPermissionRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SuccessResponse)</returns>
        public async System.Threading.Tasks.Task<Kinde.ManagementApi.Client.ApiResponse<SuccessResponse>> CreatePermissionWithHttpInfoAsync(CreatePermissionRequest? createPermissionRequest = default(CreatePermissionRequest?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> localVarResponse = DeletePermissionWithHttpInfo(permissionId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="permissionId">The identifier for the permission.</param>
        /// <returns>ApiResponse of SuccessResponse</returns>
        public Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> DeletePermissionWithHttpInfo(string permissionId)
        {
            // verify the required parameter 'permissionId' is set
            if (permissionId == null)
                throw new Kinde.ManagementApi.Client.ApiException(400, "Missing required parameter 'permissionId' when calling PermissionsApi->DeletePermission");
        ...
        {
            Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> localVarResponse = await DeletePermissionWithHttpInfoAsync(permissionId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SuccessResponse)</returns>
        public async System.Threading.Tasks.Task<Kinde.ManagementApi.Client.ApiResponse<SuccessResponse>> DeletePermissionWithHttpInfoAsync(string permissionId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'permissionId' is set
            if (permissionId == null)
                throw new Kinde.ManagementApi.Client.ApiException(400, "Missing required parameter 'permissionId' when calling PermissionsApi->DeletePermission");
        ...
        {
            Kinde.ManagementApi.Client.ApiResponse<GetPermissionsResponse> localVarResponse = GetPermissionsWithHttpInfo(sort, pageSize, nextToken);
            return localVarResponse.Data;
        }
        ...
        /// <param name="nextToken">A string to get the next page of results if there are more results. (optional)</param>
        /// <returns>ApiResponse of GetPermissionsResponse</returns>
        public Kinde.ManagementApi.Client.ApiResponse<GetPermissionsResponse> GetPermissionsWithHttpInfo(string? sort = default(string?), int? pageSize = default(int?), string? nextToken = default(string?))
        {
            Kinde.ManagementApi.Client.RequestOptions localVarRequestOptions = new Kinde.ManagementApi.Client.RequestOptions();
        ...
        {
            Kinde.ManagementApi.Client.ApiResponse<GetPermissionsResponse> localVarResponse = await GetPermissionsWithHttpInfoAsync(sort, pageSize, nextToken, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> localVarResponse = UpdatePermissionsWithHttpInfo(permissionId, createPermissionRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="createPermissionRequest">Permission details. (optional)</param>
        /// <returns>ApiResponse of SuccessResponse</returns>
        public Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> UpdatePermissionsWithHttpInfo(int permissionId, CreatePermissionRequest? createPermissionRequest = default(CreatePermissionRequest?))
        {
            Kinde.ManagementApi.Client.RequestOptions localVarRequestOptions = new Kinde.ManagementApi.Client.RequestOptions();
        ...
        {
            Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> localVarResponse = await UpdatePermissionsWithHttpInfoAsync(permissionId, createPermissionRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
