...
namespace Kinde.ManagementApi.Api
{
    ...
    public partial class TimezonesApi : IDisposable, ITimezonesApi
    {
        ...
        /// <returns></returns>
        public TimezonesApi(Kinde.ManagementApi.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public TimezonesApi(HttpClient client, Kinde.ManagementApi.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public TimezonesApi(Kinde.ManagementApi.Client.ISynchronousClient client, Kinde.ManagementApi.Client.IAsynchronousClient asyncClient, Kinde.ManagementApi.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> localVarResponse = GetTimezonesWithHttpInfo(timezoneKey, name);
        ...
        /// <param name="name">Timezone. (optional)</param>
        /// <returns>ApiResponse of SuccessResponse</returns>
        public Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> GetTimezonesWithHttpInfo(string? timezoneKey = default(string?), string? name = default(string?))
        {
            ...
            if (timezoneKey != null)
            {
                localVarRequestOptions.QueryParameters.Add(Kinde.ManagementApi.Client.ClientUtils.ParameterToMultiMap("", "timezone_key", timezoneKey));
            }
            if (name != null)
            {
        ...
        {
            Kinde.ManagementApi.Client.ApiResponse<SuccessResponse> localVarResponse = await GetTimezonesWithHttpInfoAsync(timezoneKey, name, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SuccessResponse)</returns>
        public async System.Threading.Tasks.Task<Kinde.ManagementApi.Client.ApiResponse<SuccessResponse>> GetTimezonesWithHttpInfoAsync(string? timezoneKey = default(string?), string? name = default(string?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
